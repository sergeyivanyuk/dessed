...
const modalData = {
    ...
    'Шлифовальные работы': {
        ...
        image: './images/photo_2024-06-26_19-32-19.jpg',
    ...
    'Электроэрозийная обработка': {
        title: 'Электроэрозийная обработка',
    ...
    'Сверлильные работы': {
     ...
     'Полировка металла': {
        ...
        image: './images/services/Шлифовальные работы.jpg',
   ...
   'Слесарные работы': {
    ...
    'Услуги по изготовлению изделий из МДФ': {
        ...
        image: './images/projects/МДФ (3).jpg',
