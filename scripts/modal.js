...
const modalData = {
    ...
    'фрезерные работы на универсальных и станка с ЧПУ': {
        title: 'фрезерные работы на универсальных и станка с ЧПУ',
    ...
    'Шлифовальные работы': {
        ...
        image: './images/worked/Шлифовальне работы.jpg',
   ...
   'Слесарные работы': {
       ...
       'Сварочные работы': {
        ...
        image: './images/worked/Сварочные работы.jpg',
    ...
    'Изготовление пресс-форм, штампов, приспособлений и др.': {
        ...
        image: './images/worked/photo_2024-11-27_12-20-01.jpg',
        description: 'Обладая обширным опытом и современным оборудованием, мы успешно производим пресс-формы, штампы и приспособления любой сложности.Обладая обширным опытом и современным оборудованием, мы успешно производим пресс-формы, штампы и приспособления любой сложности.',
        features: [
