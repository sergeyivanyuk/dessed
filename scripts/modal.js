...
const modalData = {
	...
	'Шлифовальные работы': {
		...
		image: './images/worked/Grinding-works.jpg',
		description:
	...
	'Электроэрозионная обработка': {
		...
		image: './images/worked/electrical-discharge-machining.jpg',
		description:
		...
		features: ['Использование современного оборудования с ЧПУ', 'Высокая точность обработки', 'Практически любая конфигурация вырезов']
	},
	'Сверлильные работы': {
		title: 'Сверлильные работы',
		image: './images/worked/drilling-works.jpg',
		description:
		...
		features: ['Идеально ровные и чистые отверстия', 'Высокая точность размеров', 'Отсутствие деформаций и сколов']
	},
	'Полировка металла': {
		title: 'Полировка металла',
		image: './images/worked/6-1.jpg',
		...
		features: ['Идеальный зеркальный блеск', 'Защита от коррозии и загрязнений', 'Обработка любых форм и контуров']
	},
	...
	'Сварочные работы': {
		...
		image: './images/worked/Welding-works2.jpg',
		description:
		...
		features: ['Высокое качество и контроль', 'Работаем с разными материалами и видами сварки', 'Создаем надежные неразъемные соединения']
	},
	...
	'Изготовление изделий из МДФ': {
		...
		features: ['Высокое качество материала', 'Современное оборудование', 'Обеспечиваем точность геометрии']
	},
	...
	'Разработка конструкторской документации': {
		...
		features: ['Работаем с любыми отраслями промышленности', 'Учитываем все ваши требования и пожелания, создавая конструкторскую документацию']
	},
	'Изготовление пресс-форм, штампов, приспособлений и др.': {
		title: 'Изготовление пресс-форм, штампов, приспособлений и др.',
		image: './images/projects/11-1.jpg',
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-contact modal-features">
                        ...
                        <ul id="modalFeatures">
                            <li><a class="modal-link" href="tel:89278175535">+7 (927) 817-55-35</a></li>
                            <li><a class="modal-link" href="mailto:dessed.d@yandex.ru">dessed.d@yandex.ru</a></li>
